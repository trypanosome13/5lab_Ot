...
class  EmployeeAccountModel(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['EmployeeAccount_Num', 'EmployeeAccount_Login', 'EmployeeAccount_Password', 'EmployeeAccount_LoginStatus', 'EmployeeAccount_RegisterDate','User_User_Num'])
