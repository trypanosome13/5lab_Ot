...
class  EquipmentFailureAccountingModel(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['EquipmentFailureAccounting_Num', 'EquipmentFailureAccounting_Date', 'EquipmentFailureAccounting_Result', 'EquipmentFailureAccounting_Cause', 'Equipment_Equipment_Num','Employee_Employee_Num'])
...
if __name__ == "__main__":
    ...
    ui =  EquipmentFailureAccountingModel()
