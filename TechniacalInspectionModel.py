...
class  TechniacalInspectionModel(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['TechniacalInspection_Num', 'TechniacalInspection_Date', 'TechniacalInspection_Result', 'Equipment_Equipment_Num','Employee_Employee_Num'])
