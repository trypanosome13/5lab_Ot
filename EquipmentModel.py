...
class  EquipmentModel(object):
    ...
    def loadconection(self):
        ...
        with db:
            cur = db.cursor()
            rows = cur.execute("""select * from EquipmentModel""")
            data = cur.fetchall()
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['Equipment_Num', 'Equipment_Name', 'ProductionSite_ProductionSite_Num'])
        ...
        self.btnAdd.setObjectName("btn_abrirbd2")
