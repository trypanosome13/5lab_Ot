...
class  ProductionSiteModel(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['ProductionSite_Num', 'ProductionSite_Name'])
